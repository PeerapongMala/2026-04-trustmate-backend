...
สำคัญ: การระบายความรู้สึก เช่น "ไม่อยากมีชีวิตอยู่" "เหนื่อยมาก" ไม่ถือว่าผิดกฎ เพราะเป็นเหตุผลที่ผู้ใช้มาใช้แอป

ตอบเป็น JSON เท่านั้น:
{"status": "clean" | "flagged" | "blocked", "reason": "เหตุผลสั้นๆ ถ้าไม่ clean"}`;
